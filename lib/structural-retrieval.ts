...
//
// Build fix: moved to lib/structural-dims.ts (client-safe, no server-only
// dependency) and re-exported here so every existing importer of this file
// keeps working unchanged. See lib/structural-dims.ts for why.
export { VECTOR_DIMS, DIM_LABELS, type VectorDimName, type VectorDim, type OntologyVector } from './structural-dims'
import { VECTOR_DIMS, DIM_LABELS } from './structural-dims'
import type { VectorDimName, VectorDim, OntologyVector } from './structural-dims'
