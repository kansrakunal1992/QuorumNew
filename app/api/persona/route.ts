    ...
    const passthrough = new ReadableStream<Uint8Array>({
      async start(controller) {
        ...
        try {
          ...
          if (sessionId && !rawMessages && userMessageContent.length > 0) {
